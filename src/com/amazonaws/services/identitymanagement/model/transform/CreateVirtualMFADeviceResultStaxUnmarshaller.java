 ...
 */
public class CreateVirtualMFADeviceResultStaxUnmarshaller implements Unmarshaller<CreateVirtualMFADeviceResult, StaxUnmarshallerContext> {

    public CreateVirtualMFADeviceResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return createVirtualMFADeviceResult;
    ...
    public static CreateVirtualMFADeviceResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new CreateVirtualMFADeviceResultStaxUnmarshaller();
        return instance;
    }
}
