...
public class GetAccountSummaryResultStaxUnmarshaller implements Unmarshaller<GetAccountSummaryResult, StaxUnmarshallerContext> {
    private static class SummaryMapMapEntryUnmarshaller implements Unmarshaller<Entry<String, Integer>, StaxUnmarshallerContext> {
        ...
        public Entry<String, Integer> unmarshall(StaxUnmarshallerContext context) throws Exception {
            ...
            MapEntry<String, Integer> entry
                = new MapEntry<String, Integer>();
        ...
        public static SummaryMapMapEntryUnmarshaller getInstance() {
            if (instance == null) instance = new SummaryMapMapEntryUnmarshaller();
            return instance;
        }
    ...
    public GetAccountSummaryResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            XMLEvent xmlEvent = context.nextEvent();
            if (xmlEvent.isEndDocument()) return getAccountSummaryResult;
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("SummaryMap/entry", targetDepth)) {
                    ...
                    getAccountSummaryResult.getSummaryMap().put(entry.getKey(), entry.getValue());
                    continue;
                }
            } else if (xmlEvent.isEndElement()) {
    ...
    public static GetAccountSummaryResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new GetAccountSummaryResultStaxUnmarshaller();
        return instance;
    }
}
