...
public class GetGroupPolicyResultStaxUnmarshaller implements Unmarshaller<GetGroupPolicyResult, StaxUnmarshallerContext> {
    ...
    public GetGroupPolicyResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return getGroupPolicyResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("GroupName", targetDepth)) {
                    getGroupPolicyResult.setGroupName(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("PolicyName", targetDepth)) {
                    getGroupPolicyResult.setPolicyName(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("PolicyDocument", targetDepth)) {
                    getGroupPolicyResult.setPolicyDocument(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static GetGroupPolicyResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new GetGroupPolicyResultStaxUnmarshaller();
        return instance;
    }
}
